...
- [ ] Collection totals
  ...
  **Need to think about the design of the code**
  ...
  - [ ] Save a separate version for your own development of mapping, and then save a cleaner copy for PR Review.
    - [ ] Delete unecessary comments
  - [ ] Start another feature branch for Update 3
    - [ ] Diff check btw last PR commit
    - [ ] Create feature branch, directly copy the differences from my current code into this new feature branch. Clone onto my local machine. Use that one for now and test deploy subgraph to see if it's working.
